...
// accounts for dot-dash time (check if correct)
const unsigned int TIME_BETWEEN_CHARS = 3*DOT_TIME - TIME_BETWEEN_DOT_DASH;
// accounts for char and dot-dash time (check if correct)
const unsigned int TIME_BETWEEN_WORDS
    = 7*DOT_TIME - TIME_BETWEEN_CHARS - TIME_BETWEEN_DOT_DASH;
...
// iterates through each character in the input string, calling a combination of
// dot() or dash() representing the character.
void loop() {

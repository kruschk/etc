...
// This array contains all relevant information regarding the state of the
// board. Each element contains the pin number and the state of an LED. The row
// and column number reflects the physical position of the LED.
